...
import { useFavorite } from "../application/favor";
...
const YourFeed = () => {
  ...
  useEffect(() => {
    const apiUrl = `https://api.realworld.io/api/articles/feed?limit=${itemsPerPage}&offset=${
  ...
  if (articles.length == 0) {
    return <p className={style.noArticle}>No articles are here... yet.</p>;
  }
          ...
          <div className={style.article} key={article.slug}>
            <div className={style.articleInfo}>
              ...
              <div className={style.favorite}>
                <button
                  className={article.favorited ? style.btnAdd : ""}
                  onClick={() =>
