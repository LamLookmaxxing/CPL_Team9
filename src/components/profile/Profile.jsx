...
const Profile = () => {
  ...
  const favoriteArticle = async (slug) => {
    ...
    try {
      ...
      const updatedFavoritedArticles = [
        ...favoritedArticles,
        updatedArticles.find((article) => article.slug === slug),
      ];
  ...
  const unfavoriteArticle = async (slug) => {
    ...
    try {
      ...
      setMyArticles(updatedArticles);
      const updatedFavoritedArticles = favoritedArticles.filter(
    ...
    <div className="profile">
      <div className="banner-profile">
        ...
        <div className="button-banner">
          <Link to="/settings">
            <button className={style.buttonEditProfile}>
              <i class="fa-solid fa-gear"></i> Edit profile settings
            </button>
          </Link>
        </div>
      </div>
                  ...
                  <div className={style.favorite}>
                    {isArticleFavorited(article) ? (
                      <button
                        ...
                        onClick={() => unfavoriteArticle(article.slug)}
                      >
